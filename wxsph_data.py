"""Excel inputs for the FastMai WeChat Store product-information form."""
...
class FrozenFields(Mapping[str, str]):
    ...
    def __setattr__(self, _name: str, _value: object) -> None:
        raise AttributeError("微信小店 Excel 字段不可修改")
...
def parse_wxsph_fields(fields: Mapping[str, Any]) -> WxsphFields:
    ...
    return WxsphFields(fields=FrozenFields(normalized))


__all__ = ["WxsphFields", "parse_wxsph_fields"]
